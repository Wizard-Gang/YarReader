...
### YR-066 — [OPS] Normalize shared package, workflow, and npm command contracts

- Dependency: YR-064 delivered; portfolio planning policy YR-065 merged. Coordinate with the same normalization task in every public sibling repository.
